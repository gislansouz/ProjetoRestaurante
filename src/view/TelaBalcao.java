 ...
 * @author gislan
 */
public class TelaBalcao extends javax.swing.JFrame {
ModeloProduto mode=new ModeloProduto();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Data e hora de abertura:");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        PreencherTabela("select produtos,quant,preco,tempo from produtosmesas where idmesa='456'");
...
public void PreencherTabela(String Sql){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBalcao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBalcao().setVisible(true);
            }
        });
    }
