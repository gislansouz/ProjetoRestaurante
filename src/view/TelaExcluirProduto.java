...
public class TelaExcluirProduto extends javax.swing.JFrame {
    ...
    int IdProdutors; 
    public TelaExcluirProduto(int Idexcluir) {
        IdProdutors = Idexcluir;
        initComponents();
        System.out.print(IdProdutors);
    }
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        mod.setCodigo(IdProdutors);
        System.out.print(mod.getCodigo());
        control.Excluir(mod);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int produto = 0;
                new TelaExcluirProduto(produto).setVisible(true);
            }
        });
    }
